...
namespace CrabGui
{
	...
	public:
		...
		/// 自定义顶点渲染（渲染目标）
		virtual Bool	renderRenderTargetVertices(RenderTarget* pRT, Int nPointSize, const PointReal* pPoints, const Color* pDiffuses, const PointReal* pTexPoints, Int nTriangleSize, const Int16* pTriangles) = 0;
